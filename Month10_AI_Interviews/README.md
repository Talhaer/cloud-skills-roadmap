...
**Focus:** Local vs cloud AI, LLM routing, cost optimization, and MLOps/LLMOps courses.
...
- [LLM routing strategies](https://www.anyscale.com/blog/llm-router)
- [Hybrid cloud vector search (Qdrant)](https://qdrant.tech/articles/hybrid-cloud-vector-search/)

---

## LLM cost optimization

- [LLM cost management (Vellum)](https://www.vellum.ai/blog/llm-cost-optimization)
- [FinOps for AI](https://www.finops.org/wg/ai-and-machine-learning/)
