...
- [Vagrant Ubuntu setup](https://developer.hashicorp.com/vagrant/tutorials/getting-started)
- [Vagrant provisioning](https://www.vagrantup.com/docs/provisioning)

### Nginx

- [Nginx beginner’s guide](https://nginx.org/en/docs/beginners_guide.html)
- [Install Nginx on Ubuntu](https://www.digitalocean.com/community/tutorials/how-to-install-nginx-on-ubuntu-20-04)

### Dockerfile + containers

- [Dockerfile best practices](https://docs.docker.com/develop/develop-images/dockerfile_best-practices/)
- [Building Docker images](https://docs.docker.com/engine/reference/builder/)

### ECS / Cloud Run / Azure Container Instances
...
- [SSL/TLS (Cloudflare)](https://www.cloudflare.com/learning/ssl/what-is-ssl/)
...
- [Kubernetes (Nana)](https://www.youtube.com/watch?v=X48VuDVv0do)
- [Kubernetes (Abhishek)](https://www.youtube.com/playlist?list=PLdpzxOOAlwvIKMhk8WhzN1pYoJ1YU8Csa)
- [Kubernetes (FreeCodeCamp)](https://www.youtube.com/watch?v=d6WC5n9G_sM)

### Managed Kubernetes

- [EKS Workshop](https://www.eksworkshop.com/)
- [GKE tutorials](https://cloud.google.com/kubernetes-engine/docs/tutorials)
- [AKS getting started](https://learn.microsoft.com/en-us/azure/aks/)

### Cost tracking

- [AWS Cost Management](https://aws.amazon.com/aws-cost-management/)
- [Kubecost](https://www.kubecost.com/)
- [Infracost (Terraform)](https://www.infracost.io/)

### Other clouds

- [DigitalOcean Kubernetes](https://docs.digitalocean.com/products/kubernetes/)
- [Linode Kubernetes](https://www.linode.com/docs/guides/deploy-and-manage-a-cluster-with-linode-kubernetes-engine-a-tutorial/)
- [Vultr Kubernetes](https://www.vultr.com/docs/vultr-kubernetes-engine/)
