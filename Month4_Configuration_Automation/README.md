# Month 4: Configuration + Automation (Ansible + Networking)

**Focus:** Ansible fundamentals, networking basics, firewall/subnetting, and a small automation project.
...
- [Ansible tutorial (TechWorld with Nana)](https://www.youtube.com/watch?v=1id6ERvfozo)
